...
public class ValidationAspect {
     ...
     * @param joinPoint
     */
    @Before("execution(public int com.mamh.spring.demo.aop.ArithmeticCalculator.*(int,int))")
     ...
     * @param joinPoint
     */
    @After("execution(public int com.mamh.spring.demo.aop.ArithmeticCalculator.*(int,int))")
    ...
    @AfterReturning(value = "execution(public int com.mamh.spring.demo.aop.ArithmeticCalculator.*(int,int))", returning = "result")
     ...
     * @param ex
     */
    @AfterThrowing(value = "execution(public int com.mamh.spring.demo.aop.ArithmeticCalculator.*(int,int))", throwing = "ex")
